...
export default function RegistroProfesionalInteligente({ setPage }: RegistroProfesionalProps) {
  ...
  const getFieldCompletionCount = () => {
    ...
    if (currentStep === 1) {
      ...
      if (formData.precio_hora) completed++;
      if (formData.telefono && validatePhone(formData.telefono)) completed++;
      if (formData.email && validateEmail(formData.email)) completed++;
...
7. coherencia_datos (objeto): { titulo_categoria: string, experiencia_descripcion: string, disponibilidad: string }
...
Retorna SOLO un objeto JSON válido con todas estas propiedades.`;
      ...
      return {
        ...
        coherencia_datos: { titulo_categoria: 'revisar', experiencia_descripcion: 'revisar', disponibilidad: 'revisar' },
          ...
          <CardContent className="pt-6">
            <div className="space-y-4">
              ...
              <div className="flex justify-between text-xs text-muted-foreground">
                ...
                <span className={currentStep === 3 ? 'text-primary font-semibold' : ''}>Contrato</span>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleFieldChange('precio_hora', e.target.value)}
